...
{G:"div",L:"ytp-mdx-privacy-popup-buttons",U:[{G:"button",Fa:["ytp-button","ytp-mdx-privacy-popup-cancel"],oa:"Annuler"},{G:"button",Fa:["ytp-button","ytp-mdx-privacy-popup-confirm"],oa:"Confirmer"}]}]}]});this.j=new g.SI(this,250);this.cancelButton=this.Ca("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Ca("ytp-mdx-privacy-popup-confirm");g.H(this,this.j);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},N9=function(a){g.W.call(this,{G:"div",
...
b=g.V(b,128)?g.HF("Erreur sur $RECEIVER_NAME",c):b.Jc()||g.V(b,4)?g.HF("Lecture sur $RECEIVER_NAME",c):g.HF("Connect\u00e9 \u00e0 $RECEIVER_NAME",c);a.Ma("statustext",b);a.j.show()}else a.j.hide()},O9=function(a,b){g.rO.call(this,"Lire sur",0,a,b);
...
this.Al={key:w6(),name:"Cet ordinateur"};this.Fi=null;this.subscriptions=[];this.rH=this.dc=null;this.kp=[this.Al];this.Rn=this.Al;this.Md=new g.kH(64);this.wN=0;this.Ff=-1;this.Xx=!1;this.Vx=this.ou=null;if(!g.sC(this.player.V())&&!g.tC(this.player.V())){a=this.player;var b=g.NK(a);b&&(b=b.Do())&&(b=new O9(a,b),g.H(this,b));b=new N9(a);g.H(this,b);g.XK(a,b.element,4);this.ou=new M9;g.H(this,this.ou);g.XK(a,this.ou.element,4);this.Xx=!!w9()}},Q9=function(a){a.Vx&&(a.player.removeEventListener("presentingplayerstatechange",
...
O9.prototype.Dj=function(a){return"cast-selector-receiver"===a?"Caster sur\u2026":this.kp[a].name};
